...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Sim! Por se tratar de materiais digitais em PDF, você receberá tudo por e-mail imediatamente após a confirmação do pagamento, independente de onde você estiver.",
  },
  {
    question: "Qual é o prazo de entrega?",
    answer:
      "Os materiais são digitais, portanto a entrega é imediata! Assim que o pagamento for confirmado, você receberá todos os PDFs no seu e-mail.",
  },
  {
    question: "Como posso acompanhar meu pedido?",
    answer:
      "Nossa equipe te acompanhará durante todo o processo via WhatsApp. Você poderá tirar dúvidas e receber atualizações sobre seu pedido.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Como os materiais são digitais (PDF), você receberá arquivos de alta qualidade. Caso tenha algum problema com o download ou abertura dos arquivos, entre em contato e resolveremos imediatamente.",
  },
  {
    question: "Como posso entrar em contato?",
    answer:
      "Você pode entrar em contato com nossa equipe através do WhatsApp clicando no botão abaixo. Estamos sempre prontos para te ajudar!",
  },
  {
    question: "Os materiais estão disponíveis em formato digital?",
    answer:
      "Sim! O Diário de Oração e Meditação é completamente digital, você receberá todos os materiais em formato PDF de alta qualidade, prontos para serem impressos ou usados digitalmente.",
  },
];
